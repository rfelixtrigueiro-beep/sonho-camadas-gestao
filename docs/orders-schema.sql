create table if not exists public.farm_orders (
  ...
  vendedor_id uuid not null references public.farm_profiles(id),
...
-- pedidos e limitam cada vendedor aos próprios pedidos. Alterações do vendedor são
-- aceitas somente nos estados editáveis do fluxo.
